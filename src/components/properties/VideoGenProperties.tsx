...
import { Video, Sparkles, DollarSign, Dice5 } from 'lucide-react';
    ...
    <div className="flex flex-col p-4 gap-5">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative border border-border-subtle rounded-lg bg-[#141414] overflow-hidden focus-within:border-accent-lime transition-colors">
          <textarea 
            ...
            placeholder="E.g.: A cinematic drone shot of mountains..."
          ...
          <div className="p-3 border-t border-border-subtle flex flex-col gap-4 bg-canvas/40">
            ...
            <div className="flex flex-col gap-1">
              <div className="flex justify-between items-center text-xs">
                <label className="text-text-muted font-medium">Duration (sec)</label>
                <span className="text-accent-lime font-mono text-[11px]">{data.duration || 5}s</span>
              </div>
              <input 
                type="range"
                min={3}
      ...
      <div className="flex items-center justify-between px-3 py-2 bg-canvas/60 border border-border-subtle rounded-xl text-xs mt-2">
        ...
        <span className="font-mono text-emerald-400 font-semibold text-[11px]">
          ~${((data.duration || 5) * 0.01).toFixed(3)} USD
        </span>
      </div>
    </div>
  );
