...
import showcaseGif1 from '../../public/showcase-1.gif';
import showcaseImg2 from '../../public/showcase-2.jpg';
import showcaseImg3 from '../../public/showcase-3.jpg';
import showcaseGif4 from '../../public/showcase-4.gif';
import {
  Globe,
  ArrowRight,
  Play,
...
export function LandingPage({ onOpenWorkflow }: LandingPageProps) {
  ...
  // ── Showcase cards ──────────────────────────────────────
  const videoCards = [
    { id: 1, title: 'Image → 8s Video', tag: 'AI Video Gen', model: 'MiniMax Video-01', gifUrl: showcaseGif1, prompt: 'Cinematic character animation, glowing emerald neon lighting' },
    ...
    { id: 4, title: 'Elemental Green Dragon', tag: 'AI Video Gen', model: 'OpenAI TTS-1 + Video', gifUrl: showcaseGif4, prompt: 'Lloyd summoning glowing emerald green light dragon, epic energy pulse' },
  ];
