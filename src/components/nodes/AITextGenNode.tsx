...
import { Type, Image as ImageIcon, Video as VideoIcon, FileText, Headphones } from 'lucide-react';
  ...
  return (
    <div className="relative group">
      ...
      <div className="absolute -top-6 left-0 text-xs font-medium text-text-primary flex items-center gap-2">
        <Type size={12} /> {meta?.name || modelId}
      </div>

      {/* Main Node Card (inner overflow-hidden) */}
